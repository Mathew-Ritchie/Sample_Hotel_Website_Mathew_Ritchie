...
export default function DynamicRoomInfoPage() {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gray-100 p-2 sm:p-8 pt-21 sm:pt-20">
            <div className="w-full max-w-4xl bg-white rounded-lg shadow-md p-2 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <div className="mt-6 flex flex-col sm:flex-row justify-center items-center gap-1 pb-5">
